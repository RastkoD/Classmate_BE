...
public class EmailServiceImpl implements EmailService {
	...
	public void sendAssessmentEmail(AssessmentEntity assessment) {
		try {
			...
			helper.setTo(assessDao.getStudentGuardian(assessment).getEmail());
			...
			e.printStackTrace();
			throw new RuntimeException("An error occured while trying to send the email", e);
		}
